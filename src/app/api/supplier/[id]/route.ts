...
export async function GET(
  ...
  try {
    ...
    // Call backend API
    const response = await fetch(endpoints.supplier.getById(id), {
      method: 'GET',
      headers,
      cache: "no-store",
    });
    ...
    console.log("Get supplier by ID response:", data);
    ...
    return NextResponse.json({
      success: true,
      message: data.message || 'Supplier fetched successfully',
      data: data.data || data
    });
  } catch (error) {
    console.error('Get supplier by ID error details:', error);
    return NextResponse.json(
      { 
        success: false, 
...
export async function PUT(
  ...
  try {
    ...
    // Call backend API
    const response = await fetch(endpoints.supplier.update(id), {
      method: 'PUT',
      headers,
    ...
    console.error('Update supplier error details:', error);
    return NextResponse.json(
      { 
        success: false, 
        message: 'Internal server error',
...
export async function DELETE(
  ...
  try {
    ...
    // Call backend API
    const response = await fetch(endpoints.supplier.delete(id), {
      method: 'DELETE',
      headers,
      cache: "no-store",
    });
    ...
    console.error('Delete supplier error details:', error);
    return NextResponse.json(
      { 
        success: false, 
        message: 'Internal server error',
