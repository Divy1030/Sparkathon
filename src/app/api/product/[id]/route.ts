...
export async function GET(
  ...
  try {
    ...
    // Call backend API
    const response = await fetch(endpoints.product.getById(id), {
      method: 'GET',
      headers,
      cache: "no-store",
    });
    ...
    console.error('Get product by ID error details:', error);
    return NextResponse.json(
      { 
        success: false, 
...
export async function PUT(
  ...
  try {
    ...
    // Call backend API
    const response = await fetch(endpoints.product.update(id), {
      method: 'PUT',
      headers,
...
export async function DELETE(
  ...
  try {
    ...
    // Call backend API
    const response = await fetch(endpoints.product.delete(id), {
      method: 'DELETE',
      headers,
      cache: "no-store",
    });
