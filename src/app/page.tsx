...
const LightMap = dynamic(() => import('../components/maps/LightMap'), {
  ssr: false,
  loading: () => (
...
export default function SupplyChainDashboard() {
  ...
  const MapSimulation = () => {
    ...
    const handleRouteCalculated = (data: RouteData | null) => {
              ...
              <div className="space-y-3">
                ...
                <div className="text-center">
                  <div className="text-xl font-bold text-green-600">
                    {routeData?.fuelSavings ? `$${routeData.fuelSavings}` : '$2,840'}
                  </div>
